...
![img](/images/BUUCTF-CRYPTO-4_writeup/image-17-1024x673.png)

这次的题目，难度也开始逐渐上来咯！当然不仅仅只有难度，还有脑洞！

![img](/images/BUUCTF-CRYPTO-4_writeup/image-18.png)

## 0x0 古典密码知多少

应该是考察古典密码的题目，点开题目下载附件，瞧一瞧

![img](/images/BUUCTF-CRYPTO-4_writeup/image-19.png)
...
![img](/images/BUUCTF-CRYPTO-4_writeup/20201019010012173.png)

圣堂武士密码对照表：

![此图像的alt属性为空；文件名为20200325180259577.jpg](/images/BUUCTF-CRYPTO-4_writeup/20200325180259577.jpg)

标准银河字母对照表：

![查看源图像](/images/BUUCTF-CRYPTO-4_writeup/t01cf49fe8b6c515f04.png)
...
![img](/images/BUUCTF-CRYPTO-4_writeup/image-139.png)
...
![img](/images/BUUCTF-CRYPTO-4_writeup/image-20.png)
